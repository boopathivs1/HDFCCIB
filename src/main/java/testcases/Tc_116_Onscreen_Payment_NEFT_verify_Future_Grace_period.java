...
public class Tc_116_Onscreen_Payment_NEFT_verify_Future_Grace_period  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC116";
		testDescription="Onscreen_Payment_NEFT_verify_Future_Grace_period";
		browserName="Chrome";
