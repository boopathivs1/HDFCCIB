...
public class Tc_115_Onscreen_Payment_Bulk_Future_Grace_Period  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC115";
		testDescription="Onscreen_Payment_Bulk_Future_Grace_Period";
		browserName="Chrome";
...
.clickAcctoAccLink()
.clickAccBulkLink()
.fillAcctoAccBulkkformFuturedate(company, branch, acc, bene, amount, remarks)
.getrefnum()
.clickLogout();		
		getnewurl();	
		new	HDFC_Login_Page(driver, test)
