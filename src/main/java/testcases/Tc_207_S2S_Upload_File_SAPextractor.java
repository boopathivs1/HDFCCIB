...
public class Tc_207_S2S_Upload_File_SAPextractor  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC207b";
		testDescription="GenericEnc-New-SAP";
		browserName="Chrome";
...
copy_file(fileurl+filename,generic_enc_new_clearfiles);
