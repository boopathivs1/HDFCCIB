...
public class Tc_163_S2S_Upload_File_SAPextractor_WithOut_confirm_FLA  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC163";
		testDescription="S2S_Upload_File_SAPextractor_Without_confirm_FLA";
		browserName="Chrome";
