...
public class Tc_253_AccountSummary_Consolidate_DownloadType  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC253";
		testDescription="AccountSummary_Consolidate_DownloadType";
		browserName="Chrome";
	...
	public void checkAccSummary(String casename,String userid,String pwd,String groupid,
			String downloadType,String compBranch,String accno,String Currency,String amount,String authuserid,
...
.clickAccountService()
.clickStatementlink()
.clickConsolidatedstatementlink()
.fillConsolidatedformDownloadType(downloadType)

.clickConsolidatedTypeDownload();
