...
public class Tc_82_Onscreen_Payment_CBECPayment_Verify_With_Confirm  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC82";
		testDescription="Onscreen_Payment_CBECPayment_Verify_With_Confirm";
		browserName="Chrome";
