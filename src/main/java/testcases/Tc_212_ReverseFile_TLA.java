...
public class Tc_212_ReverseFile_TLA  extends ProjectWrapp {
...
.clickTLA_AuthLink()
.filter_TransLevelAuth_Record(Compname,"Pending for first Authorisation", clientcode, accno, getrefnumer, paytype)
.clickTransNoSort()
.authorizeTlaRecord(Authotp)

.clickTLA_Link()
.filter_TransLevelAuth_Record(Compname,"ALL",clientcode,accno,getrefnumer,paytype)


.clickTransNoSort()
.getAuthStatus("A")

.Reverseauthorize_CheckStatus_TLA(Compname,clientcode,accno,getrefnumer,paytype);
