...
public class Tc_159_IFSC_Code_Conversion_TLA  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC159";
		testDescription="IFSC_Code_Conversion_TLA";
		browserName="Chrome";
...
.clickLogoutLink();
	...
	.clickTLA_AuthLink()
	.filter_TransLevelAuth_Record(companyname,"Pending for first Authorisation", clientcode, accno, filenameonly, paytype)
	.clickTransNoSort()
	.authorizeTlaRecord(authpwd)

	.clickTLA_Link()
	.filter_TransLevelAuth_Record(companyname,"ALL",clientcode,accno,filenameonly,paytype)


	.clickTransNoSort()
	.getAuthStatus_tla("A")

	.authorize_CheckStatus_TL(companyname,clientcode,accno,filenameonly,paytype);
