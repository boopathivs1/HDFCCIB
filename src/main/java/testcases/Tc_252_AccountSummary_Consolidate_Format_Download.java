...
public class Tc_252_AccountSummary_Consolidate_Format_Download  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC252";
		testDescription="AccountSummary_Consolidate_Format_Download";
		browserName="Chrome";
	...
	public void checkAccSummary(String casename,String userid,String pwd,String groupid,
			String Formattype,String compBranch,String accno,String Currency,String amount,String authuserid,
...
.fillConsolidatedform(Formattype)

.clickConsolidatedDownload();
