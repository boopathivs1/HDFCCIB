...
public class Tc_171_Future_Value_date_FTLA  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC171";
		testDescription="Future_Value_date_FTLA";
		browserName="Chrome";
	...
	public void checkAccSummary(String casename,String userid,String pwd,String domain
		...
		String authuserid,String authpwd,String authdomain,String future_date_count,String Compname,
		String accno,String paytype,String data5,String datas0,String data1,String data10,
		String data11,
...
int futu_date = Integer.parseInt(regvalue(future_date_count));
...
.clickLogoutLink();
	...
	.clickTLA_AuthLink()
	.CashTLAfilter_TransLevelAuth_Record(Compname,"Pending for first Authorisation", clientcode, accno,filenameonly, paytype)
	.clickTransNoSort()
	.cash_getBooking_TLAFuturedate(future_date_count)
	.authorizeFTlaRecord(authpwd)

	.clickTLA_Link()
	.CashTLAfilter_TransLevelAuth_Record(Compname,"ALL",clientcode,accno,filenameonly,paytype)
	.clickTransNoSort()
	.getftlaAuthStatus(filenameonly,"A")
	.CashAuthorizeFTLAStatus(filenameonly, Compname, clientcode, accno, paytype,filenameonly)
