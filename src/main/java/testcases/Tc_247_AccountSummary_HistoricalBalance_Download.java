...
public class Tc_247_AccountSummary_HistoricalBalance_Download  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC247";
		testDescription="AccountSummary_HistoricalBalance_Download";
		browserName="Chrome";
...
.clickAccountService()
.clickBalancelink()
.clickHistoryBalancelink()
.fillHistoryBalanceSummaryform(compid,compBranch,accnum)
.SelectRecord()
.clickDownload();
defaultcontent();		
clickLogoutLink();
