...
public class Tc_325_Commercial_Credit_Card  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC325";
		testDescription="Commercial_Credit_Card";
		browserName="Chrome";
...
.clickCommercialCreditcard()
.ClickAccessCommercialCreditcard()
