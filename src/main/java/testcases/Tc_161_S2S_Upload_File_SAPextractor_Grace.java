...
public class Tc_161_S2S_Upload_File_SAPextractor_Grace  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC161";
		testDescription="S2S_Upload_File_SAPextractor_With_Grace Period_FLA";
		browserName="Chrome";
	...
	public void checkAccSummary(String casename,String userid,String pwd,String domain
		...
		String authuserid,String authpwd,String authdomain,String grace_date_count,String data2,
...
.clickLogoutLink();
	...
	.clickfilenameSort()
	.getValuedate()
	.getGracedate(Integer.parseInt(regvalue(grace_date_count)))
	...
	. getGrace_currentdate(currentdate);
