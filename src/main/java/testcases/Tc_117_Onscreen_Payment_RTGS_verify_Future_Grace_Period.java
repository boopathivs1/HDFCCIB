...
public class Tc_117_Onscreen_Payment_RTGS_verify_Future_Grace_Period  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC117";
		testDescription="Onscreen_Payment_RTGS_verify_Future_Grace_Period";
		browserName="Chrome";
