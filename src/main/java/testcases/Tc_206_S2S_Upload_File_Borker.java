...
public class Tc_206_S2S_Upload_File_Borker  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC206d";
		testDescription="GenericEnc-Old-Broker";
		browserName="Chrome";
...
//			modifyFile(Renamedfilename_loc,value,currentdate);
			...
			copy_file(fileurl+filename,generic_enc_old_clearfiles);
