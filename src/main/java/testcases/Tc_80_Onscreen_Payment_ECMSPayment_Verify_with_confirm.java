...
public class Tc_80_Onscreen_Payment_ECMSPayment_Verify_with_confirm  extends ProjectWrapp {
	@BeforeClass(groups={"common"})
	public void setDatag() {
		testCaseName="TC80";
		testDescription="Onscreen_Payment_ECMSPayment_Verify_with_confirm";
		browserName="Chrome";
