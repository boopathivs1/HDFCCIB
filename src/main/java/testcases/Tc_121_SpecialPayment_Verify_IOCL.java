...
public class Tc_121_SpecialPayment_Verify_IOCL  extends ProjectWrapp {
...
.clickAcctoAccLink()
.clickSplpaymentLink()
.fillSplpaymentIOCLform_future_Date(Format, bene, amount, remark, company, branch, acc, statecode, Prodcode)
.getrefnum()
.clickLogout();		
		getnewurl();	
		new	HDFC_Login_Page(driver, test)
